...
orientation_list = ['acetic_acid_a', 'acetic_acid_b','acetic_acid_c', 'acetic_acid_d']
for orientation in orientation_list:
    convert_psi4_to_gaussian_esp_from_xyz(f'../../multiple_orientations/{orientation}_grid.dat',
                                          f'../../multiple_orientations/{orientation}_esp.dat',
                                          f'../../multiple_orientations/{orientation}.xyz',
                                          f'{orientation}_gaussian.dat')
    convert_psi4_to_gaussian_esp_from_xyz(f'../../multiple_orientations/{orientation}_grid.dat',
                                          f'../../multiple_orientations/{orientation}_esp.dat',
                                          f'../../multiple_orientations/{orientation}_x.xyz',
                                          f'{orientation}_x_gaussian.dat')
